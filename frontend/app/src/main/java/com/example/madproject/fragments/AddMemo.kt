 ...
 * Use the [AddMemo.newInstance] factory method to
 * create an instance of this fragment.
 */
class AddMemo : Fragment() {
    ...
    override fun onCreateView(
        ...
        val submit = view.findViewById<Button>(R.id.add)

        submit.setOnClickListener {
            val memo = view.findViewById<EditText>(R.id.memo).text.toString()
            Toast.makeText(activity,memo, Toast.LENGTH_SHORT).show()
        }
        return view
    }
